/*
  This file contains a reference to the vendor libraries we're using in this project.
  ...
  So all the libraries we're reference here will be writen to vendor.js so they can be cached until one of them change.
